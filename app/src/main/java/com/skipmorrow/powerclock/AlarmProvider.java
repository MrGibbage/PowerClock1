...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.skipmorrow.powerclock", "alarm", ALARMS);
        sURLMatcher.addURI("com.skipmorrow.powerclock", "alarm/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    "(hour, minutes, daysofweek, alarmtime, enabled, vibrate, message, alert, skipnext) " +
                    "VALUES ";
            db.execSQL(insertMe + "(7, 0, 127, 0, 0, 1, '', '', 0);");
            db.execSQL(insertMe + "(8, 30, 31, 0, 0, 1, '', '', 0);");
            db.execSQL(insertMe + "(9, 00, 0, 0, 0, 1, '', '', 0);");
        }

        @Override
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
            if (Log.LOGV) Log.v(this, 
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        if (ret == null) {
            if (Log.LOGV) Log.v(this, "Alarms.query: failed");
        } else {
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        //boolean skipNext = values.getAsInteger("skipnext") == 0 ? false : true;
        Log.d(this, "*** notifyChange() rowId: " + rowId + " url " + url);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        if (Log.LOGV) Log.v(this, "Added alarm rowId = " + rowId);
