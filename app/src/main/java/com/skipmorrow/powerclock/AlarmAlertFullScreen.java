...
public class AlarmAlertFullScreen extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Log.d(this, "Creating an AlarmAlertFullScreen instance");
    }
    
    @Override
    public void onAttachedToWindow() {
        final Window win = getWindow();
        Log.d(this, "onCreate() about to set layout flags");
        win.addFlags(WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED
        		| WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD);
        // Turn on the screen unless we are being launched from the AlarmAlert
        // subclass.
        if (!getIntent().getBooleanExtra(SCREEN_OFF, false)) {
            Log.d(this, "!getBoolean(SCREEN_OFF)");
    ...
    private NotificationManager getNotificationManager() {
        Log.d(this, "getNotificationManager");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Log.LOGV) Log.v(this, "AlarmAlert.OnNewIntent()");
    ...
    protected void onStop() {
        ...
        Log.d(this, "onStop");
        if (!isFinishing()) {
            Log.d(this, "!isFinishing");
            // Don't hang around.
            // finish(); // removed this line to make it possible for the alert to show over a lock screen.
        } else {
            Log.d(this, "isFinishing");
        }
    }
    ...
    public void onDestroy() {
        ...
        if (Log.LOGV) Log.v(this, "AlarmAlert.onDestroy()");
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        Log.d(this, "dispatchKeyDownEvent");
