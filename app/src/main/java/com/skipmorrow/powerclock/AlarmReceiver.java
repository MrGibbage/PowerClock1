...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (data != null) {
            ...
            // added next line because of a compiler warning
            in.recycle();
        }

        if (alarm == null) {
            Log.v(this, "AlarmReceiver failed to parse the alarm from the intent");
            return;
        }
	...
	private void updateNotification(Context context, Alarm alarm, int timeout) {
        ...
        if (alarm == null) {
            if (Log.LOGV) {
                Log.v(this, "Cannot update notification for killer callback");
            }
            return;
        }
